...
<div class="col-8 mx-auto">
	<div class="row">
		...
		<?php 
			...
			$join = mysqli_query($con, 'SELECT * FROM users INNER JOIN posts ON users.id = posts.author_id');
			$res = $query->fetch_assoc();
			$stroka = $join->fetch_assoc();
		?>
		<div class="col-3 text-center">
			<div>
				<img src="<?php echo $res['avatar'] ?>" class="w-100 img">
		...
		<div class="col-7 pt-3">
			<div class="col-12 border-bottom" >
				<h5><?php echo $res['name']; echo " "; echo $res['surname']; ?></h5>
				<h5><?php echo $res['city']; echo " "; echo $res['education']; ?></h5>
				<p class="text-secondary">Изменить статус</p>

			</div>
			<form method="POST" action="post.php" enctype="multipart/form-data">
				<input type="" name="text"  placeholder="" class="form-control">
